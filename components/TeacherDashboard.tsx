        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-6 animate-fadeInUp">
            ...
            {questions.filter(q => !q.isCorrect).map((q, i) => (
              <div key={i} className="mb-6 p-4 border-l-4 border-red-500 bg-red-50 hover:shadow-md transition">
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`bg-${statusColor}-50 rounded-lg shadow p-6 border-l-4 border-${statusColor}-500 animate-fadeInUp`}>
            <h2 className={`text-2xl font-bold text-${statusColor}-700 mb-4`}>{statusLabel} Topics ({topics.length})</h2>
            <div className="space-y-3">
              {topics.map((topic, i) => (
                <div key={i} className="bg-white p-4 rounded border-l-4 border-gray-300 hover:shadow-lg transition transform hover:translate-x-1">
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6 animate-slideInLeft">
          <h1 className="text-3xl font-bold">Teacher Dashboard</h1>
          <div className="space-x-3">
            <button onClick={handleClearAll} className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition transform hover:scale-105">
              Clear All Records
            </button>
            <button onClick={onBack} className="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700 transition transform hover:scale-105">
              Back
            </button>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6 animate-fadeInUp">
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                {(() => {
                  ...
                  return (
                    <>
                      <div className="bg-red-50 p-4 rounded border-l-4 border-red-500 cursor-pointer hover:bg-red-100 transition transform hover:scale-105" onClick={() => setShowTopicList('weak')}>
                      ...
                      <div className="bg-yellow-50 p-4 rounded border-l-4 border-yellow-500 cursor-pointer hover:bg-yellow-100 transition transform hover:scale-105" onClick={() => setShowTopicList('medium')}>
                      ...
                      <div className="bg-green-50 p-4 rounded border-l-4 border-green-500 cursor-pointer hover:bg-green-100 transition transform hover:scale-105" onClick={() => setShowTopicList('strong')}>
              ...
              <div className="bg-blue-50 p-4 rounded border-l-4 border-blue-500 animate-pulse-glow">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden animate-fadeInUp">
              ...
              {attempts.map(attempt => (
                <tr key={attempt.id} className="border-t hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4 space-x-2">
                    <button onClick={() => viewDetails(attempt)} className="text-blue-600 hover:underline hover:text-blue-800 transition">
                      View
                    </button>
                    <button onClick={() => handleDelete(attempt.id)} className="text-red-600 hover:underline hover:text-red-800 transition">
                      Delete
                    </button>
                  </td>
                </tr>
